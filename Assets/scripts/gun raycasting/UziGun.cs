...
public class UziGun : MonoBehaviour
{
    ...
    void Update()
    {
        if (isUziActive == true)
        {
            animator.runtimeAnimatorController = Resources.Load<RuntimeAnimatorController>("UziGunController");
