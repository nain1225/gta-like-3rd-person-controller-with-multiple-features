...
public class PoliceOfficer02 : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (playerInvisionRadius && !playerInshootingRadius &&  WantedLevelScript.WantedLevel2 == true || WantedLevelScript.WantedLevel3 == true || WantedLevelScript.WantedLevel4 == true || WantedLevelScript.WantedLevel5 == true)
        {
            ChasePlayer();
        }
        if (playerInvisionRadius && playerInshootingRadius &&  WantedLevelScript.WantedLevel2 == true || WantedLevelScript.WantedLevel3 == true || WantedLevelScript.WantedLevel4 == true || WantedLevelScript.WantedLevel5 == true)
    ...
    public void getPolice02Damage(float takeDamage)
    {
